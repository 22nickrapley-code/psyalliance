...
// to its own page - the main /dashboard/planner route is now the always-on
// per-client recommendation table. Kept exactly as it worked before; only
// the route and this intro paragraph changed.
export default async function CoveragePlansPage(
  ...
  return (
    <div>
      <p>
        <a href="/dashboard/planner" className="muted" style={{ fontSize: "0.85rem" }}>&larr; Back to Planner</a>
      </p>
      <h1>Coverage plans</h1>
      <p className="muted">
        ...
        through. For day-to-day referrals, use the main{" "}
        <a href="/dashboard/planner">Planner</a> table instead - this project-based tool is for
        planned leave/coverage windows specifically.
      </p>
